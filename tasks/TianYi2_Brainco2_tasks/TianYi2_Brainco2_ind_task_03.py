...
logger.info("TianYi2_Brainco2_ind_task_03 imports all deps")


@Registry.register("TianYi2_Brainco2_ind_task_03")
class TianYi2_Brainco2_ind_task_03(TianYi2_Brainco2_Task_Base):
    TIER = 1
