...
logger.info("TianYi2_Brainco2_ind_task_02 imports all deps")


@Registry.register("TianYi2_Brainco2_ind_task_02")
class TianYi2_Brainco2_ind_task_02(TianYi2_Brainco2_Task_Base):
    TIER = 1
