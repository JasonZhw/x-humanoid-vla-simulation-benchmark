...
class SimCam:
    ...
    def __init__(self,
        ...
        if orientation_to_pass is not None and match_cfg_quat_to_isaac_ui:
            try:
                # Translation only supports quaternions in the form of WXYZ: 
                # First perform normalization, and then conduct fixed bias compensation.
    ...
    def get_rgb(self, out_buffer=None):
